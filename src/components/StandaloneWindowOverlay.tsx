  ...
  return (
    <div className='fixed inset-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm z-50 flex items-center justify-center'>
      <div className='text-center max-w-md p-8'>
        ...
        <h2 className='text-2xl font-bold text-gray-900 dark:text-white mb-2'>{t('app.standaloneWindowOpen')}</h2>
        <p className='text-gray-600 dark:text-gray-400 mb-6'>{t('app.standaloneWindowMessage')}</p>
      </div>
    </div>
  );
};
